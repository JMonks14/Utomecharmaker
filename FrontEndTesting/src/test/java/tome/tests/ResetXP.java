...
public class ResetXP {
	...
	@Test
	public void restXPChar() throws InterruptedException {
		driver.manage().timeouts().implicitlyWait(4000, TimeUnit.MILLISECONDS);
		this.viewChar.getResetButton().click();
		Thread.sleep(1000);
		driver.switchTo().alert().accept();
		Thread.sleep(3000);
		assertEquals("You have not yet bought any skills.",this.viewChar.getNospace().getText());
	}
